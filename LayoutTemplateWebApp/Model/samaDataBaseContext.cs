...
{
    public partial class samaDataBaseContext : DbContext
    {
        public samaDataBaseContext()
        {
        }

        public samaDataBaseContext(DbContextOptions<samaDataBaseContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=samaDataBase.mssql.somee.com;Initial Catalog=samaDataBase;Persist Security Info=False;User ID=mariolara21_SQLLogin_1;Password=q2gyfakvls;Packet Size=4096;Workstation ID=samaDataBase.mssql.somee.com");
            }
        }
